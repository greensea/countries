...
// String - implements fmt.Stringer, returns a chinese name of country. Translated by ChatGPT, be CAREFUL of political risks
//
//nolint:gocyclo
func (c CountryCode) StringChn() string { //nolint:gocyclo
	switch c {
	case 8:
		return "阿尔巴尼亚"
	case 12:
